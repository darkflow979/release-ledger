...
export const zhipuEntries: readonly Entry[] = [
  {
    id: "glm-5-2",
    slug: "glm-5-2",
    type: "model",
    ...
    whyItMatters:
      "One of the strongest open-weight coding models from a Chinese lab in mid-2026. MIT license makes it particularly practical for commercial and research use.",
    links: [
      {
        label: "Hugging Face",
